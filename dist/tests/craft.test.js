...
import { fabricateBase, addAffix, upgradeAffix, affixTierCost, } from "../game/crafting/crafting.js";
...
console.log("== Serialization round-trip ==");
{
    ...
    assert(approx(c2.computeStats().minionDamage, c.computeStats().minionDamage), "Computed stats identical after round-trip");
}
console.log("");
if (failures > 0) {
...
//# sourceMappingURL=craft.test.js.map