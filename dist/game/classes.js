...
export const CLASSES = {
    warrior: {
        ...
        description: "A frontline juggernaut who crushes foes in melee. High life and armour, " +
    ...
    ranger: {
        ...
        description: "A nimble marksman raining arrows from range. Scales with Dexterity for " +
    ...
    summoner: {
        ...
        description: "A commander of the dead. Raises skeletal minions to fight in their stead " +
    ...
    elementalist: {
        ...
        description: "A master of raw elemental fury. Hurls fire, ice, and lightning, scaling " +
...
export const PLAYABLE_CLASSES = ["warrior", "ranger", "summoner", "elementalist"];
