...
import { STAT_NAMES } from "../game/stats.js";
...
const INCREASED_AS_PERCENT = new Set([
    "physicalDamage",
    "fireDamage",
    "coldDamage",
    "lightningDamage",
...
export function formatModifier(mod) {
    ...
    const asPercent = mod.kind === "increased" ||
...
export function itemTooltipHtml(item) {
    ...
    // Implicit.
    lines.push(`<div class="tooltip-line implicit">${formatModifier({
    ...
    for (const roll of item.affixes) {
        ...
        lines.push(`<div class="tooltip-line mod">${formatModifier({
            stat: affix.stat,
            kind: affix.kind,
            value: t.value,
